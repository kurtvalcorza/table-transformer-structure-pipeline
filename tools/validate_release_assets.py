...
WORKSHOP_NOTEBOOK_NAME = "DIMER_Table_Intelligence_Workshop.ipynb"
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    1_066_042: "dataset bevaya/SciTSR-pd dae336e data/test-00000-of-00001.parquet",
    5_185_141: "dataset bevaya/SciTSR-pd dae336e data/train-00000-of-00001.parquet",
}
...
def validate_release_status() -> None:
    ...
    # The primary generated notebook carries the repository status. The supplemental workshop
    # carries its own status, which may trail the repository (Candidate while primary is
    # Release-grade) but must never lead it.
    rows = {
